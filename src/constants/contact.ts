export const CONTACT_INFO = {
  ...
  address: {
    ...
    zip: '551 01',
    city: 'Jaroměř',
    part: 'Jakubské Předměstí',
    full: 'Náchodská 118, 551 01 Jaroměř, Jakubské Předměstí',
  },
  billing: {
    company: 'VMK Consulting Group s.r.o.',
    street: 'Dandova 2619/13',
    city: 'Praha 9',
    zip: '193 00',
    ico: '193 81 735',
    register: 'Zapsána v obchodním rejstříku vedeným Krajským soudem v Praze, oddíl C, vložka 385168',
  },
  socials: {
    facebook: 'https://www.facebook.com/PneuservisVMK/',
